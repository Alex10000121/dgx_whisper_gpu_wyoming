...
NGC-Account für nvcr.io (kostenlos): ngc.nvidia.com
Externes Docker-Netzwerk ai_network:

bash  docker network create ai_network
Setup
bash# 1. NGC Login
...
VariableStandardOptionenWHISPER_MODELlarge-v3tiny, base, small, medium, large-v1, large-v2, large-v3WHISPER_LANGdede, en, fr, auto, ...WHISPER_BEAM_SIZE51–10
Home Assistant
